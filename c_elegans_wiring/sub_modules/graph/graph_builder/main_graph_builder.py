import c_elegans_wiring.sub_modules.pre_processor as pre_processing
...
import c_elegans_wiring.sub_modules.graph.group_classes as group_classes
...
def build_sub_cell_graph(graph_obj, output_folder=None):
    ...
    if output_folder:
        dot_path = output_folder + '/filtered_cell_graph.dot'
        csv_path = output_folder + '/inter_neuron_cells_filtered.csv'
